...
import 'package:samvaad/screens/FlipCardScreen.dart';
...
class _LevelScreenState extends State<LevelScreen4> {
      ...
      onTap: () {
        if (unlockedLevels == level) {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => FlipCardScreen()), // Navigate to Quiz Screen
          );
        }
      },
      child: Column(
